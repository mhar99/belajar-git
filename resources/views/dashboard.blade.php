...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('acaraa.index') }}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="pemilihan.html">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Pemilihan</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="hasil_vote.html">
                    <i class="fas fa-fw fa-cog"></i>
                                                ...
                                                <div class="col">
                                                    <div class="progress progress-sm mr-2">
                                                        <div class="progress-bar bg-info" role="progressbar"
                                                            style="width: 99%" aria-valuenow="50" aria-valuemin="0"
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; evoting</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
